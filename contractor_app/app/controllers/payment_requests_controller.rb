class PaymentRequestsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @payment_request.save
        format.html { redirect_to payment_request_url(@payment_request), notice: "Payment request was successfully created." }
  ...
  def payment_request_params
    params.require(:payment_request).permit(:user_id, :amount, :currency, :description, :status)
  end
end
