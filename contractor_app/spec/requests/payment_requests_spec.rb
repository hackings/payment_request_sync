...
RSpec.describe "/payment_requests", type: :request do
  ...
  let(:invalid_attributes) {
    {amount: nil, currency: "USD", description: "contractor payment request invalid attrs"}
  }
  ...
  describe "POST /create" do
    ...
    context "with invalid parameters" do
      it "does not create a new PaymentRequest" do
        expect {
          post payment_requests_url, params: {payment_request: invalid_attributes}
        }.to change(PaymentRequest, :count).by(0)
      end
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      let(:new_attributes) {
        {amount: 55, currency: "SGD", description: "contractor payment request new attrs"}
      }
